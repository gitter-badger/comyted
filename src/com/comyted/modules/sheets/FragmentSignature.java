...
public class FragmentSignature extends Fragment 								
{
		...
		public void onActivityCreated(Bundle savedInstanceState) {		
			...
			if(clientSignature!=null){
				((ImageView) firmacliente.findViewById(R.id.imageView1)).setImageBitmap(clientSignature);
			}
			if(techSignature!=null){
				((ImageView) firmatecnico.findViewById(R.id.imageView1)).setImageBitmap(techSignature);
			}					
